...
public enum ErrorCode {
    ...
    EMAIL_ALREADY_EXISTS("4043", "email already exists"),
    USER_DOES_NOT_HAVE_ACCESS("4044", "user does not have access"),
    USER_NOT_IN_ORGANIZATION("4045", "user not in organization"),
